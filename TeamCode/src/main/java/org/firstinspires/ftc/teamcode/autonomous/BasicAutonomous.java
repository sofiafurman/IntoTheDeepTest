...
public class BasicAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        leftFrontDrive.setTargetPosition(538*3);
        rightBackDrive.setTargetPosition(538*3);   // (3 wheel turns)
        rightFrontDrive.setTargetPosition(538*3);
        leftBackDrive.setTargetPosition(538*3);
