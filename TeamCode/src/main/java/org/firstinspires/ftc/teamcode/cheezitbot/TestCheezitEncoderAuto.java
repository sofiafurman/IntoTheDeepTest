...
/* I'm having some difficulties getting encoders to
 run on Cheezitbot, so this is a simplified
 encoder autonomous run for the drive base. */
...
//@Disabled
public class TestCheezitEncoderAuto extends LinearOpMode {
